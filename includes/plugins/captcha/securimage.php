...
class Securimage {
	 ...
	 * @var mixed
	 */
	var $gd_font_file = 'captcha/gdfonts/caveman.gdf';
	 ...
	 * @var int
	 */
	var $text_transparency_percentage = 50;
	 ...
	 * @var string
	 */
	var $audio_path = 'includes/plugins/captcha/audio/';
	...
	function __construct()
	{
		...
		$this->image_width = $system->SETTINGS['image_captcha_width'];
		$this->code_length = $system->SETTINGS['image_captcha_length'];
		$this->site_url = $system->SETTINGS['siteurl'];
		
		$this->gd_font_file = 'includes/plugins/captcha/gdfonts/bubblebath.gdf';
		$this->ttf_file = 'includes/plugins/captcha/elephant.ttf';
	}
...
<div style="width: 550px; display:block; margin-left:auto; margin-right:auto; margin-top:20px;">
	...
	<div style="width: 430px; float: left; height: 55px; display: block;"> 
		<img id="siimage" align="left" style="padding-right: 5px; border: 0" src="' . $this->site_url . 'captcha.php?sid=' . md5(uniqid(time())) . '" /> 
		<object type="application/x-shockwave-flash" data="' . $this->site_url . 'includes/plugins/captcha/securimage_play.swf?audio_file=' . $this->site_url . 'captcha_play.php" width="25" height="24" />  
		<param name="movie" value="' . $this->site_url . 'includes/plugins/captcha/securimage_play.swf?audio_file=' . $this->site_url . 'captcha_play.php" />  
</object> 
<br /> 
		<a style="border-style: none; margin-left: 1px" href="#" title="Refresh Image" onclick="document.getElementById(\'siimage\').src = \'' . $this->site_url . 'captcha.php?sid=\' + Math.random(); return false">
			<img src="' . $this->site_url . 'includes/plugins/captcha/images/refresh.gif" alt="Reload Image" border="0" onclick="this.blur()" align="bottom" />
		</a>
	</div>
	...
	<div class="col-sm-5" style="display:block;"> 
		<input type="text" name="captcha_code" class="form-control" size="' . $this->code_length . '" maxlength="' . $this->code_length . '" />
	</div>
</div>';
	}
