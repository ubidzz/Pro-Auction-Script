<?php
/*
	needs to be cleaned up to meet Pro-Auction-Script coding standards
...
define('CAPTCHA_BASE_URL', $system->SETTINGS['siteurl'] . 'includes/plugins/captcha/captcha.php');
