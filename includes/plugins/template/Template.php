...
class Template
{
	...
	*/
	function _tpl_load(&$handle)
	{
		...
		{
			include(PLUGIN_PATH . 'template/TemplateCompile.php');
		}
	...
	*/
	function assign_vars($vararray)
	{
		...
		{
			$this->_rootref['_ACSRFTOKEN'] = $_SESSION['admincsrftoken'];
			$this->_rootref['_ACSRFFORM'] = '<input type="hidden" name="admincsrftoken" value="' . $_SESSION['admincsrftoken'] . '">';
		}
		return true;
	}
	/**
